        ...
        <footer>
            ...
            >
                ...
                <div className="footer-shop-div">
                    <h3 className="brand-name" itemProp="name">
                        Le jardin aux fleurs sauvages
                    </h3>
                    <p
                        itemProp="address"
                        itemScope
                    ...
                    >
                        <span itemProp="streetAddress">1 rue du petit ruisseau</span>
                        <br></br>
                    ...
                    <p>
                        Ouverture du{" "}
                        <span itemProp="openingHours" content="Mo,Tu,We,Th, Fr 10:00-7:00">
                ...
                <div className="footer-contact-shop-div">
                    ...
                    <div className="footer-telephone-div">
                        ...
                        <p itemProp="telephone">01 28 01 19 92</p>
                        <br></br>
                    </div>
                    <br></br>
                    <div className="footer-contact-form">
                        <i className="fa-solid fa-envelope enveloppe"></i>
                        <a href="/The-flower-power-project/contact">
